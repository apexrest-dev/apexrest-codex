...
The default npm tag is `latest`. To pin release 1.0.0, use `npm install -g apexrest@1.0.0`. See [release notes](../../docs/release-notes.md) for distribution and verification status.
