---
name: apexrest-panel
description: Open the live APEXREST development panel inside Codex desktop or Codex CLI. Inspect project settings, named agent sessions, tools, reviews, QA, source changes and APEX operation state; start or steer reviewed implementation tasks.
---
