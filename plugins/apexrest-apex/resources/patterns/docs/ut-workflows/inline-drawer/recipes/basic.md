# Inline drawer open and close — original example / Відкриття та закриття вбудованої висувної панелі

Open and dismiss an inline drawer from explicit page controls while retaining the surrounding page context.

Status: ready.

Source: universal-theme-reference; pages 1916.
...
```apexlang
page 1 (
    name: Inline drawer workspace
    alias: HOME
    title: Inline drawer workspace
    appearance {
    ...
    region example (
        ...
        advanced {
            htmlDomId: workflow_inline_drawer
        }
        appearance {
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "97f7c16b22d23b538373e4715143986535bde571763b5ab146242d6618f7b730",
