# Inline drawer open and close / Вбудована панель із відкриттям і закриттям
  ...
  "examples": [
    {
      ...
      "behavior": "Open and dismiss an inline drawer from explicit page controls while retaining the surrounding page context."
    }
  ],
...
- pattern:ut-workflows/inline-drawer/recipes/basic: ready
