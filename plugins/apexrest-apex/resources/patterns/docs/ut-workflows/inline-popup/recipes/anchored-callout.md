# Inline popup anchored to its opener / Вбудоване спливне вікно прив’язане до кнопки відкриття

Open a contextual popup anchored to a declared button DOM ID, with a native close action and no initialization side effects.
...
page 1 (
    ...
    region example (
        ...
        advanced {
            ...
            customAttributes: data-parent-element="#workflow_open_popup"
        }
        appearance {
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "24c518c67bc1da3a28c6bc666efa08594ad43946e5ddf5eed7c2024e39a04c44",
