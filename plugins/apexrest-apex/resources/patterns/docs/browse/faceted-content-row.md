# Faceted content row browser / Перегляд списку з фасетними фільтрами
...
[
  ...
  "The results region presents one content row per matching record."
]
```
...
- pattern:browse/faceted-content-row/recipes/basic: ready
- pattern:browse/faceted-content-row/recipes/range-feature-groups: ready
