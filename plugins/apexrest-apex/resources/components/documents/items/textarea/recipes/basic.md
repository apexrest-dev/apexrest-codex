...
Textarea form item with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1601. Component: component:items/textarea.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "17b28077fa72d135657314af56f97b0a11042828b0a47fd5a869a31b5260d5dd",
