# DisplayOnly form item

DisplayOnly form item with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1601. Component: component:items/display-only.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "3513008dc4fcd57bb1aa16a8d60955eff2fb55a198e976b10f4b0d8f01969b63",
