...
QrCode form item with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1601. Component: component:items/qr-code.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "b249a1209957766f9cba61541d962800e77096dae6964ef9dccf00024f73b05e",
