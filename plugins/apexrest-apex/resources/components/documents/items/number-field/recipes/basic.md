# NumberField form item

NumberField form item with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1601. Component: component:items/number-field.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "aaba7670d578d629f6ddb63c4b7ba9646ace623cf3e37f2269174db599d24d48",
