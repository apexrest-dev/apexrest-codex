...
Switch form item with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1601. Component: component:items/switch.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "1f3665a1ebfe9b4e412639c37ebefc77d108879d8886746b08831ed26d037af5",
