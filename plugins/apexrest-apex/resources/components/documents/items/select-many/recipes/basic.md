# SelectMany form item

SelectMany form item with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1601. Component: component:items/select-many.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "3b6b7e3fb8948570e43df3367454075aa1d9a58ba398d15cfb40b4c66db7c9e3",
