...
```json
{
  ...
  "nativeParameters": [
    ...
    {
      "id": "native:item/selectList/component/execute_validations",
      "context": "pageItem",
      "scope": "component",
      "nativeType": "selectList",
      ...
      "description": "Execute Validations setting for selectList.",
      "descriptionOrigin": "apexrest-factual-summary",
      "sourceDigest": "00697878fc6b3148ee199b582b5ebd9b6c0cc6dde8a8b4cceb8a5664adb2ef0b"
    },
    {
      "id": "native:item/selectList/component/page_action_on_selection",
      "context": "pageItem",
      "scope": "component",
      "nativeType": "selectList",
      ...
      "condition": {},
      "source": "SQLcl native declarations 26.1.0+3102",
      "description": "Page Action on Selection setting for selectList.",
      "descriptionOrigin": "apexrest-factual-summary",
      "sourceDigest": "5d1beed209381fd9482859f4497636f9a12b21369f66198ee07368c8fcf0d3a7"
    }
  ],
  "currentExamples": {
    "regions": [],
    "items": [
      {
        "id": "page:423/item:P423_SELECT_LIST",
        "pageId": 423,
        "key": "P423_SELECT_LIST",
        "type": "selectList",
      ...
      {
        "id": "page:1601/item:P1601_SELECT_LIST",
        "pageId": 1601,
        "key": "P1601_SELECT_LIST",
        "type": "selectList",
        "template": "Optional",
        "templateOptions": [
          "#DEFAULT#"
      ...
      {
        "id": "page:3005/item:P3005_ORDER_BY",
        "pageId": 3005,
        "key": "P3005_ORDER_BY",
        "type": "selectList",
        "template": "Optional - Floating",
      ...
      {
        "id": "page:4000/item:P4000_ANIMATION",
        "pageId": 4000,
        "key": "P4000_ANIMATION",
        "type": "selectList",
        "template": "Optional",
      ...
      {
        "id": "page:4000/item:P4000_MODIFIER",
        "pageId": 4000,
        "key": "P4000_MODIFIER",
        "type": "selectList",
        "template": "Optional",
      ...
      {
        "id": "page:4000/item:P4000_MODIFIER_STATUS",
        "pageId": 4000,
        "key": "P4000_MODIFIER_STATUS",
        "type": "selectList",
        "template": "Optional",
        "templateOptions": [
          "#DEFAULT#"
      ...
      {
        "id": "page:4000/item:P4000_ROTATE",
        "pageId": 4000,
        "key": "P4000_ROTATE",
        "type": "selectList",
        "template": "Optional",
