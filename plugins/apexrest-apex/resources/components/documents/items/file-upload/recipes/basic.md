...
FileUpload form item with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1601. Component: component:items/file-upload.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "a2be9f98597f2d67fd328587dce1b491974a8a83eed72666acee30cef328964b",
