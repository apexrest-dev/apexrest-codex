# Metric Card in Interactive Report column

Metric Card in Interactive Report column with self-contained synthetic data and explicit component mappings.
...
page 1 (
    ...
    region results (
        ...
        source {
            ...
            sqlQuery:
                ```sql
                select 'Open tasks' TITLE, 12 METRIC, 'Synthetic example' META, 'component' COMPONENT from dual
                ```
        }
        layout {
            sequence: 10
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "8ec67c6de33a636de02bb75786aa3c4d8f962f26fe25be69b8fc0ab00429d3dc",
