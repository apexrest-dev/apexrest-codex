# Metric Card report with link action

Metric Card report with link action with self-contained synthetic data and explicit component mappings.
...
page 1 (
    ...
    region example (
        ...
        source {
            ...
            sqlQuery:
                ```sql
                select 'Open tasks' TITLE, 12 METRIC, 'Synthetic example' META from dual
                ```
        }
        layout {
            sequence: 10
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "7ba428dc2e3f0a506a9556b87405eac534cfc17c8805a2f7cdd13af47966854c",
