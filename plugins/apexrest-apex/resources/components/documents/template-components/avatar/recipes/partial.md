...
Avatar partial with self-contained synthetic data and explicit component mappings.
...
page 1 (
    ...
    region example (
        ...
        source {
            ...
            sqlQuery:
                ```sql
                select 'EX' INITIALS from dual where rownum <= 1
                ```
        }
        layout {
            sequence: 10
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "b9a81050392ea15504702ece45fb65b6c98e8a9f1b6491782a7951dc947291fd",
