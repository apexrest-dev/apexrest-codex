# Avatar in Interactive Report column

Avatar in Interactive Report column with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 3001. Component: component:template-components/avatar.
...
page 1 (
    ...
    region results (
        ...
        source {
            ...
            sqlQuery:
                ```sql
                select 'EX' INITIALS, 'component' COMPONENT from dual
                ```
        }
        layout {
            sequence: 10
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "b0067b23dcd89d4099e3a211a65d7890c3ba399ddf84637db693d13f3454d3f1",
