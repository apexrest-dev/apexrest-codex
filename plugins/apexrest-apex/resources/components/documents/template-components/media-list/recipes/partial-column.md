# Media List in Interactive Report column

Media List in Interactive Report column with self-contained synthetic data and explicit component mappings.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "56d3b7e39eb627a72acfc6879d758d204f7828bc9aeb8d4156dc8cbbb4fca094",
