...
Media List report with self-contained synthetic data and explicit component mappings.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "868eae731ce888b5e4f24a7ec11bae5d0505fbdd38af9a09f04e05545c785efd",
