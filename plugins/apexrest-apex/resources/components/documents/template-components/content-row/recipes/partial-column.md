# Content Row in Interactive Report column

Content Row in Interactive Report column with self-contained synthetic data and explicit component mappings.
...
page 1 (
    ...
    region results (
        ...
        source {
            ...
            sqlQuery:
                ```sql
                select 'Example entry' TITLE, 'Local description' DESCRIPTION, 'component' COMPONENT from dual
                ```
        }
        layout {
            sequence: 10
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "2714e1b40dba164a8f8e0cbed4c0a47c829d68550b67d778a97ca0c701734e9f",
