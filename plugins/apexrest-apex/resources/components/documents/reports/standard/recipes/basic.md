# Standard Classic Report template

Standard Classic Report template with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1401. Component: component:reports/standard.
