# Classic Report Contextual Info

Classic Report Contextual Info with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1307. Component: component:reports/contextual-info.
...
page 1 (
    ...
    region results (
        ...
        source {
            ...
            sqlQuery:
                ```sql
                select 'Example title' TITLE, 'Example status' STATUS from dual
                ```
        }
        layout {
            sequence: 10
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "921521ce231084195d1f889c6602545dca934b264d4e867f04420d28388d320d",
