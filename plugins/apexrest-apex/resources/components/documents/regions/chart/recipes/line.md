...
Chart line with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1902. Component: component:regions/chart.
    ...
    region example (
        ...
        series values (
            ...
            source {
                ...
                sqlQuery:
                    ```sql
                    select 'Alpha' LABEL, 12 VALUE from dual union all select 'Beta', 7 from dual
                    ```
            }
            columnMapping {
                label: LABEL
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "0e45e73b00a695971aef7cb219718115d033a3d2445dac758bcb0466bf07b84f",
