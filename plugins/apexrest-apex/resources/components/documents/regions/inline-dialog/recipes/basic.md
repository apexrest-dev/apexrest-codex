...
Inline Dialog with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1911. Component: component:regions/inline-dialog.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "9fc68c69739bebedacf6d84d5427114d90287d7ccd0cb8a8cab05f74425da897",
