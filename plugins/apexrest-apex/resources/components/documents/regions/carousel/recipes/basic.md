...
Carousel Region with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1205. Component: component:regions/carousel.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "ce33dc7a605a0ea33dc0092aa60f63249ecdb397960866c0df1fe9d91c42ded8",
