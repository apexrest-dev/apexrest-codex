...
```json
{
  ...
  "nativeParameters": [
    ...
    {
      "id": "native:region/staticContent/component/expand_shortcuts",
      "context": "region",
      "scope": "component",
      "nativeType": "staticContent",
      "attributeKey": "expandShortcuts",
      "builderLabel": "Expand Shortcuts",
      "apexlangPath": "region.settings.expandShortcuts",
      "type": "yesNo",
      "required": false,
      "defaultValue": null,
      "values": [],
      "condition": {
        "dependingOn.attribute": "@output_as/component",
        "dependingOn.conditionType": "=",
        "dependingOn.value": "HTML"
      },
      "source": "SQLcl native declarations 26.1.0+3102",
      "description": "Expand Shortcuts setting for staticContent.",
      "descriptionOrigin": "apexrest-factual-summary",
      "sourceDigest": "91983c021119742a214473fbf0b6e2c383edd73d7d31546e75abdfff004e894f"
    },
    {
      "id": "native:region/staticContent/component/output_as",
      "context": "region",
      "scope": "component",
      "nativeType": "staticContent",
      "attributeKey": "outputAs",
      "builderLabel": "Output As",
      "apexlangPath": "region.settings.outputAs",
      "type": "selectList",
      "required": true,
      "defaultValue": "HTML",
      "values": [
      ...
      "condition": {},
      "source": "SQLcl native declarations 26.1.0+3102",
      "description": "Output As setting for staticContent.",
      "descriptionOrigin": "apexrest-factual-summary",
      "sourceDigest": "b5e96be2bea50b8016e302a5bc95cb10f7ff221964ad143568a70f9c998aa72b"
    },
    {
      "id": "native:region/staticContent/component/show_line_breaks",
      "context": "region",
      "scope": "component",
      "nativeType": "staticContent",
      "attributeKey": "showLineBreaks",
      "builderLabel": "Show Line Breaks",
      "apexlangPath": "region.settings.showLineBreaks",
      "type": "yesNo",
      "required": false,
      "defaultValue": "true",
      "values": [],
      "condition": {
        "dependingOn.attribute": "@output_as/component",
        "dependingOn.conditionType": "=",
        "dependingOn.value": "TEXT"
      },
      "source": "SQLcl native declarations 26.1.0+3102",
      "description": "Show Line Breaks setting for staticContent.",
      "descriptionOrigin": "apexrest-factual-summary",
      "sourceDigest": "8f45eea9019a411e7d10b07ec58abe8e7779e73266cd6448ff0553b3dc4e5780"
    }
  ],
  "currentExamples": {
    "regions": [
      {
        "id": "page:1201/region:region-title",
        "pageId": 1201,
        "key": "region-title",
        "type": "staticContent",
        "template": "Standard",
      ...
      {
        "id": "page:1201/region:standard-region-template",
        "pageId": 1201,
        "key": "standard-region-template",
        "type": "staticContent",
        "template": "Standard",
        "componentTemplate": null,
        "regionOptions": [
      ...
      {
        "id": "page:3008/region:left-column",
        "pageId": 3008,
        "key": "left-column",
        "type": "staticContent",
        "template": "Standard",
      ...
      {
        "id": "page:3008/region:region-1_1",
        "pageId": 3008,
        "key": "region-1_1",
        "type": "staticContent",
        "template": "Standard",
      ...
      {
        "id": "page:3008/region:region-2_1",
        "pageId": 3008,
        "key": "region-2_1",
        "type": "staticContent",
        "template": "Standard",
      ...
      {
        "id": "page:3008/region:region-3_1",
        "pageId": 3008,
        "key": "region-3_1",
        "type": "staticContent",
        "template": "Standard",
      ...
      {
        "id": "page:3008/region:right-column",
        "pageId": 3008,
        "key": "right-column",
        "type": "staticContent",
        "template": "Standard",
      ...
      {
        "id": "page:6100/region:appearance",
        "pageId": 6100,
        "key": "appearance",
        "type": "staticContent",
        "template": "Standard",
      ...
      {
        "id": "page:6100/region:template-options",
        "pageId": 6100,
      ...
      {
        "id": "page:6100/region:usage-instructions",
        "pageId": 6100,
