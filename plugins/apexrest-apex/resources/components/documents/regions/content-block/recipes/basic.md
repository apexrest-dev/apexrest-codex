...
Content Block with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1209. Component: component:regions/content-block.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "a8c6ff720cc16cc5caa8ba0487801b6f87db9ce50a07dd78de1fbaef80f7d9d7",
