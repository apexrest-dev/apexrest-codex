...
Faceted Search with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1411. Component: component:regions/faceted-search.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "32faa0ea1a3e17aa9fe7328a2838919ccfa84033212b4f35f272513d23eea118",
