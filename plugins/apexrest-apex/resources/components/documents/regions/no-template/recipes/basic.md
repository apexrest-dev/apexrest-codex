# No Template region wrapper

A region without an explicit appearance template reference. The source inventory records missing template metadata as no-template; no nonexistent @/no-template reference is emitted.

Status: ready.

Source pages: 1905. Component: component:regions/no-template.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "8010d5169edfbf99c720c53b5438f4effa2f73ddcc65b934223a6d6a4c6bb504",
