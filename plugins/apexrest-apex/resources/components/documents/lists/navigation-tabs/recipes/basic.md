...
Navigation Tabs with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1121. Component: component:lists/navigation-tabs.
...
page 1 (
    ...
    region example (
        ...
        componentAppearance {
            listTemplate: @/top-navigation-tabs
            templateOptions: #DEFAULT#
        }
    )
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "c709a4fb6c1c1b24ea9f1c3087bbdb0ff55138ab4d4fa948d800c6269dfe4a5f",
