...
```json
{
  ...
  "nativeParameters": [
    ...
    {
      "id": "native:item/radioGroup/component/execute_validations",
      "context": "pageItem",
      "scope": "component",
      "nativeType": "radioGroup",
      "attributeKey": "executeValidations",
      "builderLabel": "Execute Validations",
      "apexlangPath": "pageItem.settings.executeValidations",
      "type": "yesNo",
      "required": false,
      "defaultValue": "true",
      "values": [],
      "condition": {
        "dependingOn.attribute": "@page_action_on_selection/component",
        "dependingOn.conditionType": "=",
        "dependingOn.value": "SUBMIT"
      },
      "source": "SQLcl native declarations 26.1.0+3102",
      "description": "Execute Validations setting for radioGroup.",
      "descriptionOrigin": "apexrest-factual-summary",
      "sourceDigest": "267db3bfd3299418b42915a6751fee0734ef68c86306576008305427bfbd0643"
    },
    {
      "id": "native:item/radioGroup/component/hide_radio_buttons",
      "context": "pageItem",
      "scope": "component",
      "nativeType": "radioGroup",
      "attributeKey": "hideRadioButtons",
      "builderLabel": "Hide Radio Buttons",
      "apexlangPath": "pageItem.settings.hideRadioButtons",
      "type": "yesNo",
      "required": false,
      "defaultValue": null,
      "values": [],
      "condition": {},
      "source": "SQLcl native declarations 26.1.0+3102",
      "description": "Hide Radio Buttons setting for radioGroup.",
      "descriptionOrigin": "apexrest-factual-summary",
      "sourceDigest": "b720cd0fa35d59e92745cdc156f4f80ac8c02535dd130377be9015b1b012fb31"
    },
    {
      "id": "native:item/radioGroup/component/number_of_columns",
      "context": "pageItem",
      "scope": "component",
      "nativeType": "radioGroup",
      "attributeKey": "noOfCols",
      "builderLabel": "Number of Columns",
      "apexlangPath": "pageItem.settings.noOfCols",
      "type": "integer",
      "required": true,
      "defaultValue": "1",
      "values": [],
      "condition": {},
      "source": "SQLcl native declarations 26.1.0+3102",
      "description": "Number of Columns setting for radioGroup.",
      "descriptionOrigin": "apexrest-factual-summary",
      "sourceDigest": "0680eb9ece33c0c7b9c9c0ab87e6f0d05c8fe8844c74a8e8cc7bf2d8da559ce2"
    },
    {
      "id": "native:item/radioGroup/component/page_action_on_selection",
      "context": "pageItem",
      "scope": "component",
      "nativeType": "radioGroup",
      "attributeKey": "pageActionOnSelection",
      "builderLabel": "Page Action on Selection",
      "apexlangPath": "pageItem.settings.pageActionOnSelection",
      "type": "selectList",
      "required": true,
      "defaultValue": "NONE",
      "values": [
        ...
        {
          "name": "redirectSetValue",
          "label": "Redirect and Set Value",
          "returnValue": "REDIRECT_SET_VALUE"
        },
        {
          "name": "submitPage",
          "label": "Submit Page",
      ...
      "condition": {},
      "source": "SQLcl native declarations 26.1.0+3102",
      "description": "Page Action on Selection setting for radioGroup.",
      "descriptionOrigin": "apexrest-factual-summary",
      "sourceDigest": "b4922ad36229e788ad11503c329d787af3bf45a22d0e5f1ad856509cb1311900"
    }
  ],
  "currentExamples": {
    "regions": [],
    "items": [
      {
        "id": "page:423/item:P423_RADIO_GROUP",
        "pageId": 423,
        "key": "P423_RADIO_GROUP",
        "type": "radioGroup",
      ...
      {
        "id": "page:1204/item:P1204_RADIO_A",
        "pageId": 1204,
        "key": "P1204_RADIO_A",
        "type": "radioGroup",
        "template": "Optional",
      ...
      {
        "id": "page:1204/item:P1204_RADIO_B",
        "pageId": 1204,
        "key": "P1204_RADIO_B",
        "type": "radioGroup",
        "template": "Optional",
      ...
      {
        "id": "page:1601/item:P1601_RADIO_GROUP",
        "pageId": 1601,
        "key": "P1601_RADIO_GROUP",
        "type": "radioGroup",
        "template": "Optional",
        "templateOptions": [
          "#DEFAULT#"
      ...
      {
        "id": "page:1601/item:P1601_RADIO_GROUP_AS_BUTTONS",
        "pageId": 1601,
        "key": "P1601_RADIO_GROUP_AS_BUTTONS",
        "type": "radioGroup",
        "template": "Optional",
        "templateOptions": [
          "#DEFAULT#",
      ...
      {
        "id": "page:4000/item:P4000_FA_SIZE",
        "pageId": 4000,
        "key": "P4000_FA_SIZE",
        "type": "radioGroup",
        "template": "Optional",
      ...
      {
        "id": "page:4000/item:P4000_ICON_SIZE",
        "pageId": 4000,
        "key": "P4000_ICON_SIZE",
        "type": "radioGroup",
        "template": "Optional",
      ...
      {
        "id": "page:6100/item:P6100_BUTTON_SET",
        "pageId": 6100,
        "key": "P6100_BUTTON_SET",
        "type": "radioGroup",
        "template": "Optional",
        "templateOptions": [
          "#DEFAULT#"
      ...
      {
        "id": "page:6100/item:P6100_BUTTON_TEMPLATE",
        "pageId": 6100,
        "key": "P6100_BUTTON_TEMPLATE",
        "type": "radioGroup",
        "template": "Optional",
        "templateOptions": [
          "#DEFAULT#",
      ...
      {
        "id": "page:6100/item:P6100_ICON_POSITION",
        "pageId": 6100,
        "key": "P6100_ICON_POSITION",
        "type": "radioGroup",
        "template": "Optional",
        "templateOptions": [
          "#DEFAULT#"
      ...
      {
        "id": "page:6100/item:P6100_SPACING_BOTTOM",
        "pageId": 6100,
        "key": "P6100_SPACING_BOTTOM",
        "type": "radioGroup",
        "template": "Optional",
        "templateOptions": [
          "#DEFAULT#"
      ...
      {
        "id": "page:6100/item:P6100_SPACING_LEFT",
        "pageId": 6100,
        "key": "P6100_SPACING_LEFT",
        "type": "radioGroup",
        "template": "Optional",
        "templateOptions": [
          "#DEFAULT#"
      ...
      {
        "id": "page:6100/item:P6100_SPACING_RIGHT",
        "pageId": 6100,
        "key": "P6100_SPACING_RIGHT",
        "type": "radioGroup",
        "template": "Optional",
        "templateOptions": [
          "#DEFAULT#"
      ...
      {
        "id": "page:6100/item:P6100_SPACING_TOP",
        "pageId": 6100,
        "key": "P6100_SPACING_TOP",
        "type": "radioGroup",
        "template": "Optional",
        "templateOptions": [
          "#DEFAULT#"
