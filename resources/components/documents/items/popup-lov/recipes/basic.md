...
PopupLov form item with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1601. Component: component:items/popup-lov.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "df6edafe950dbf111e2319a469825f0583ca02b9de2c9ea2daa54dc2f8a032a8",
