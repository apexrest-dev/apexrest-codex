...
```json
{
  ...
  "nativeParameters": [
    ...
    {
      "id": "native:item/password/component/submit_when_enter_pressed",
      "context": "pageItem",
      "scope": "component",
      "nativeType": "password",
      ...
      "description": "Submit when Enter pressed setting for password.",
      "descriptionOrigin": "apexrest-factual-summary",
      "sourceDigest": "e25c7e257922521157189794122b9b8660bfa2cf705843e79d0ab15abbfed654"
    }
  ],
  "currentExamples": {
    "regions": [],
    "items": [
      {
        "id": "page:423/item:P423_PASSWORD",
        "pageId": 423,
        "key": "P423_PASSWORD",
        "type": "password",
      ...
      {
        "id": "page:1114/item:P1114_PASSWORD",
        "pageId": 1114,
        "key": "P1114_PASSWORD",
        "type": "password",
        "template": "Hidden",
      ...
      {
        "id": "page:1601/item:P1601_PASSWORD",
        "pageId": 1601,
        "key": "P1601_PASSWORD",
        "type": "password",
        "template": "Optional",
      ...
      {
        "id": "page:9999/item:P9999_PASSWORD",
        "pageId": 9999,
        "key": "P9999_PASSWORD",
        "type": "password",
        "template": "Hidden",
