...
Checkbox form item with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1601. Component: component:items/checkbox.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "23459a26e861badab13de43984eacfbec78fe8a179d4404ae6ce0e6e70a1b435",
