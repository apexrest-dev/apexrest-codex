# ImageUpload form item

ImageUpload form item with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1601. Component: component:items/image-upload.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "4a675862438ed8f6428f5efa763eee9d6de336f7047923a45ae608106a56dc77",
