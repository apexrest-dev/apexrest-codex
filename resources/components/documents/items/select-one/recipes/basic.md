...
SelectOne form item with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1601. Component: component:items/select-one.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "91317b51b61a8bc4983ec65868d4cb0be8a83082af8a2872079e877d73cdc8a3",
