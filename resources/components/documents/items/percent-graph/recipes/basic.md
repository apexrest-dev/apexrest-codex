# PercentGraph form item

PercentGraph form item with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1601. Component: component:items/percent-graph.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "d58b17e23751a855edf32d25b63cdf60bcbf401ec9222a0c77c9ae07e3da82a8",
