# SelectList form item

SelectList form item with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1601. Component: component:items/select-list.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "46db10c142aa6405bfec52e03d7483c511918f15f9f7248dadc5882d4528b1dc",
