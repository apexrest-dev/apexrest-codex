...
Media List partial with self-contained synthetic data and explicit component mappings.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "37506a77423e9c9be9406f71aaf85a0614d5eccedf85b5788d0232db02807f8c",
