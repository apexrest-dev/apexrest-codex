# Flexbox Container basic

Flexbox Container basic with self-contained synthetic data and explicit component mappings.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "0d44aa41409dd57511239b1c7908cf61e0d3c0ed4be64af7a315f07bd72d9ab2",
