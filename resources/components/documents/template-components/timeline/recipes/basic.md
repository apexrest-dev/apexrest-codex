...
Timeline report with self-contained synthetic data and explicit component mappings.
...
page 1 (
    ...
    region example (
        ...
        source {
            ...
            sqlQuery:
                ```sql
                select 'Example user' USER_NAME, 'Record created' TITLE, timestamp '2026-01-01 09:00:00' EVENT_DATE from dual
                ```
        }
        layout {
            sequence: 10
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "e88c97960676cca000904381fbcf1de94756c3b76c8ec5c34f35cd3b70355cb3",
