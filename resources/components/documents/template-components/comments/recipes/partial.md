...
Comments partial with self-contained synthetic data and explicit component mappings.
...
page 1 (
    ...
    region example (
        ...
        source {
            ...
            sqlQuery:
                ```sql
                select 'Example user' USER_NAME, 'A local comment.' COMMENT_TEXT, timestamp '2026-01-01 09:00:00' COMMENT_DATE from dual where rownum <= 1
                ```
        }
        layout {
            sequence: 10
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "3bd5acb6cde605167fc26ebc83de313ed070f72e1d33700cd76115fd43e0d8bb",
