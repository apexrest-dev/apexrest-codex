# Metric Card multipleSelection

Metric Card multipleSelection with self-contained synthetic data and explicit component mappings.
...
page 1 (
    ...
    region example (
        ...
        rowSelection {
            ...
            selectAllPageItem: P1_SELECT_ALL
        }
    )
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "c9bac1c9d67801f65a9761c2710e7ba930fb3512d99c17b62355ec0f6536dfc8",
