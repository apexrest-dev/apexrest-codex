...
Badge partial with self-contained synthetic data and explicit component mappings.
...
page 1 (
    ...
    region example (
        ...
        source {
            ...
            sqlQuery:
                ```sql
                select 'Open' STATUS from dual where rownum <= 1
                ```
        }
        layout {
            sequence: 10
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "afec1daaf991bf87f0254278005fd39d1dabea9f655f3450292f479e3985007a",
