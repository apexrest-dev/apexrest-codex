...
Read-only Form with self-contained synthetic data and explicit component mappings.
...
page 1 (
    ...
    region form (
        ...
        source {
            ...
            sqlQuery:
                ```sql
                select 1 ID, 'Example record' TITLE from dual
                ```
        }
        layout {
            sequence: 10
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "31a1008e628c21063b4e0d3215baf8068466809b7f224d79734038421568ac79",
