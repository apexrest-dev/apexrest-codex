...
Button Container Region with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1204. Component: component:regions/buttons-container.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "aa7ccbe3591a3ee10fad76654961ad515c261e7e0076e4a48857ac28e7a37a9b",
