...
Calendar with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1800. Component: component:regions/calendar.
...
page 1 (
    ...
    region example (
        ...
        source {
            ...
            sqlQuery:
                ```sql
                select 1 ID, 'Planning' TITLE, date '2026-01-01' START_DATE, date '2026-01-02' END_DATE from dual
                ```
        }
        layout {
            sequence: 10
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "c351dbe4e88ffc3c3fec3ef67b500e809e9bd80c44ceaa2d157cfa8f069368d4",
