...
Column Toggle Report with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1720. Component: component:reports/column-toggle-report.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "22a10731f1e788bd5bb217db68614e0b4567bf62e8e2ac7161b7454df115da9d",
