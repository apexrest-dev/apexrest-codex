# Classic Report Value Attribute Pairs Row

Classic Report Value Attribute Pairs Row with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1403. Component: component:reports/value-attribute-pairs-row.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "9625ead3aa650c3a6dc644a77b84bdb7609c04a499d07b36a2651a74adfad97a",
