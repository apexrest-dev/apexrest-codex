...
Media List with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1301. Component: component:lists/media-list.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "76f33616e42a22fb696d0541a0a3c26d34c7e316fe3f01eed2a0b8bf202416b4",
