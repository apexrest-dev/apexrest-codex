...
Side Navigation Menu with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1123. Component: component:lists/side-navigation-menu.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "a2047b8d2d377911518014e1d5d9abc7610aaefb4fc737d4b54946e4b793ad36",
