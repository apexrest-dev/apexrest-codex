...
Badge List with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1304. Component: component:lists/badges-list.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "c3d0fb01ca9b55405163bda06a8c849b0ce0ab078fb24d1249ce6aa856a2a0de",
