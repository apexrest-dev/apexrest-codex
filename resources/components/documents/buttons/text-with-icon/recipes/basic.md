...
Text With Icon Button with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1500. Component: component:buttons/text-with-icon.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "d92cb56a8df822391ad3ed777232be6909c61f4398180b4e077e24daa10236b6",
