...
Text Button with self-contained synthetic data and explicit component mappings.

Status: ready.

Source pages: 1500. Component: component:buttons/text.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "20f132ddbfc2401d73be2378b2eadaf0486504f7cef64c3566594053ece8af5e",
