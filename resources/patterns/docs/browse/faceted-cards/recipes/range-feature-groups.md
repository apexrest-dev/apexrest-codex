# Faceted cards with date range and grouped flags / Картки з фасетами діапазону дат і групами ознак
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "a2ab3e742afa1d46b4a154f355bf42497adbdedc6430fe3a63190039a77426c5",
