# Inline dialog open and close — original example / Відкриття та закриття вбудованого діалогу

Open and dismiss an inline dialog from explicit page controls while retaining the surrounding page context.

Status: ready.

Source: universal-theme-reference; pages 1911.
...
```apexlang
page 1 (
    name: Inline dialog workspace
    alias: HOME
    title: Inline dialog workspace
    appearance {
    ...
    region example (
        ...
        advanced {
            htmlDomId: workflow_inline_dialog
        }
        appearance {
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "5e98ed23c2eb185d6a1d2c77d60d1c4f653d7fdd1b4106f72d71a257ae93ad96",
