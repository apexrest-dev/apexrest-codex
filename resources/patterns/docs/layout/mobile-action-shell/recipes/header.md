# Sticky header navigation / Закріплена навігація вгорі мобільної сторінки

Two protected local pages with a native persistent header and working page navigation.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "7a67dd1efcf33d048e01f24d4f223f4222f0868f2fc1581aaf3c36dde254973c",
