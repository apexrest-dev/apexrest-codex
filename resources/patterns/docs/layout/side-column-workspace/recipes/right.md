# Workspace with right supporting columns / Робоча область із правою допоміжною колонкою

Original read-only content assigned to native right column slots.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "9d02e806b9f524bf8503213660515aabf679d09f214fd866298c8e771df1b650",
