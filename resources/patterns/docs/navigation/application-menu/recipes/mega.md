# Mega navigation / Мегаменю навігації застосунку

Native mega navigation with three local pages and no inert preview targets.
...
page 1 (
    ...
    navigationMenu {
        ...
        list: @workspace-menu
        listPosition: top
        listTemplate: @/top-navigation-mega-menu
        templateOptions: #DEFAULT#
    }
    security {
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "b8b5d691b383d22b15415b0e60d0c4f7f90d33d19253d34e9a6dcd44b4494261",
