# Tab navigation / Навігація застосунку вкладками

Native tab navigation with three local pages and no inert preview targets.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "e1ebe4804f1237128ca92440fcffb50166a6cf24f508f5114a0638351006028c",
