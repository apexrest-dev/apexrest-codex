# Popup navigation: hierarchy / Спливне меню навігації з ієрархією

Native menu trigger, nested entries and local routes.
...
```json
{
  "compiler": {
    ...
    "sourceSha256": "c3aa2e4d0bc9e0546975acfe3a5c3734ce033805b5007d7ed7752921b301c881",
