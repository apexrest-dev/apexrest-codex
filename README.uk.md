...
Використовуйте Node 24 LTS (підтримуваний діапазон: Node 24–26). Ціль цього випуску — [пакет apexrest](https://www.npmjs.com/package/apexrest) `0.5.0-beta.1` у каналі npm `beta`. Статус публікації та перевірку реєстру наведено в [записі публікації](docs/evidence/npm-050-publication.json). Канал `latest` залишається на `0.4.0-beta.1`.
