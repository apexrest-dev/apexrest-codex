...
Використовуйте Node 24 LTS (підтримуваний діапазон: Node 24–26). Ціль цього випуску — [пакет apexrest](https://www.npmjs.com/package/apexrest) `0.5.0` як npm `latest`. Фактичний статус і перевірку реєстру наведено в [записі публікації](docs/evidence/npm-050-stable-publication.json). Попередню бету можна встановити за точною версією.
