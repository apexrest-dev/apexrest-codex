...
> **Бета: `0.2.0-beta.1`.** Додано підключення через ORDS HTTP(S) і зрозуміліші налаштування з’єднань; див. [примітки до випуску](docs/release-notes.uk.md). Реальну компіляцію шаблонів Oracle, цикл експорту й імпорту незміненого застосунку через ORDS та нативне встановлення в Codex виконано в межах наведених нижче доказів. Готовність стабільного випуску досі заблокована рештою інтеграційних, відновлювальних і платформних перевірок. APEXREST — незалежний інструмент, а не офіційний продукт Oracle чи OpenAI.
