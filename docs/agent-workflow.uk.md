...
| Модель і рівень міркування | Успадковуються з конфігурації Codex. Панель показує фактичні значення, повернуті Codex; окремого вибору моделі для ролі немає. |
