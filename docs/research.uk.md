...
Це історичний запис дослідження від 2026-09-12. Він не є поточною архітектурою виконання; дивіться [інтеграцію Codex](codex-integration.uk.md). Старі спостереження протоколів хоста не описують залежність середовища виконання 1.1.0.
